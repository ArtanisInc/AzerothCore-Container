...
| 11 | `mod-transmog` | Ajoute la transmogrification avec un PNJ près de l'entraîneur de portails dans chacune des huit capitales. | [azerothcore/mod-transmog](https://github.com/azerothcore/mod-transmog) |
| 12 | `mod-reagent-bank-account` | Ajoute une banque de composants par personnage, sans limite, avec 12 PNJ près des banques des capitales, de Shattrath et de Dalaran. | [Brian-Aldridge/mod-reagent-bank-account](https://github.com/Brian-Aldridge/mod-reagent-bank-account) |
